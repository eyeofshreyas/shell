import QtQuick
import "../../utils/functions/StringUtils.qml" as StringUtils
import "../../utils/functions/FileUtils.qml" as FileUtils
import "../../utils/functions/ObjectUtils.qml" as ObjectUtils
...
ApiStrategy {
    ...
    function buildRequestData(model: AiModel, messages, systemPrompt: string, temperature: real, tools: list<var>, filePath: string) {
        ...
        if (filePath && filePath.length > 0) {
            const trimmedFilePath = Ai.trimFileProtocol(filePath);
    ...
    function buildScriptFileSetup(filePath) {
        ...
        // print("escaped file path:", Ai.shellSingleQuoteEscape(trimmedFilePath))

        content += `IMAGE_PATH='${Ai.shellSingleQuoteEscape(trimmedFilePath)}'\n`;
